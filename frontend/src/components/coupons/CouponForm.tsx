...
import { checkoutCouponsCreateBody, checkoutCouponsUpdateBody } from "@/api/generated/shop/checkout/checkout.zod"
...
export function CouponForm({
  ...
  const schema = isEditMode ? checkoutCouponsUpdateBody : checkoutCouponsCreateBody
  ...
  const handleSubmit = form.handleSubmit(async (data: CouponFormData) => {
    // Transform the form data to match the Zod schema
