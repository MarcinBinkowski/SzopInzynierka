...
import { catalogSuppliersCreateBody, catalogSuppliersUpdateBody } from "@/api/generated/shop/catalog/catalog.zod"
...
export function SupplierForm({
  ...
  const schema = isEditMode ? catalogSuppliersUpdateBody : catalogSuppliersCreateBody
