...
import { checkoutCouriersCreateBody, checkoutCouriersUpdateBody } from "@/api/generated/shop/checkout/checkout.zod"
...
export function CourierForm({
  ...
  const schema = isEditMode ? checkoutCouriersUpdateBody : checkoutCouriersCreateBody
