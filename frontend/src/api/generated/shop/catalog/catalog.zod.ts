...
export const catalogProductsListQueryParams = zod.object({
  ...
  "created_at": zod.coerce.string().datetime({}).optional(),
  "created_at__gte": zod.coerce.string().datetime({}).optional(),
  "created_at__lte": zod.coerce.string().datetime({}).optional(),
  ...
  "updated_at": zod.coerce.string().datetime({}).optional(),
  "updated_at__gte": zod.coerce.string().datetime({}).optional(),
  "updated_at__lte": zod.coerce.string().datetime({}).optional()
})
