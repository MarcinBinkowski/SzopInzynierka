...
export const checkoutCartsRetrieveResponse = zod.object({
  ...
  "price": zod.string().regex(checkoutCartsRetrieveResponseItemsItemProductPriceRegExp).describe('Product price'),
  "original_price": zod.string().regex(checkoutCartsRetrieveResponseItemsItemProductOriginalPriceRegExp).describe('Original price for showing discounts'),
  ...
  "website": zod.string().url().max(checkoutCartsRetrieveResponseItemsItemProductManufacturerWebsiteMax).optional().describe('Manufacturer website URL'),
  ...
  "unit_price": zod.string().regex(checkoutCartsRetrieveResponseItemsItemUnitPriceRegExp).describe('Price per unit when added to cart'),
  ...
  "price": zod.string().regex(checkoutCartsRetrieveResponseShippingMethodPriceRegExp).describe('Shipping cost')
  ...
  "discount_amount": zod.string().regex(checkoutCartsRetrieveResponseAppliedCouponDiscountAmountRegExp).describe('Fixed discount amount'),
...
export const checkoutCartsUpdateResponse = zod.object({
  ...
  "price": zod.string().regex(checkoutCartsUpdateResponseItemsItemProductPriceRegExp).describe('Product price'),
  "original_price": zod.string().regex(checkoutCartsUpdateResponseItemsItemProductOriginalPriceRegExp).describe('Original price for showing discounts'),
  "current_price": zod.string().describe('Get current price as formatted decimal string.'),
  "discount_percentage": zod.number().describe('Calculate discount percentage.'),
  ...
  "description": zod.string().optional().describe('Manufacturer description'),
  "website": zod.string().url().max(checkoutCartsUpdateResponseItemsItemProductManufacturerWebsiteMax).optional().describe('Manufacturer website URL'),
  "is_active": zod.boolean().optional().describe('Whether this manufacturer is visible'),
  "active_product_count": zod.number(),
  "created_at": zod.string().datetime({}).describe('Timestamp when the record was created'),
  "updated_at": zod.string().datetime({}).describe('Timestamp when the record was last updated')
  ...
  "unit_price": zod.string().regex(checkoutCartsUpdateResponseItemsItemUnitPriceRegExp).describe('Price per unit when added to cart'),
  "total_price": zod.number().describe('Get total price for this item.'),
  "created_at": zod.string().datetime({}).describe('Timestamp when the record was created'),
  "updated_at": zod.string().datetime({}).describe('Timestamp when the record was last updated')
}).describe('Serializer for CartItem model.')),
  ...
  "price": zod.string().regex(checkoutCartsUpdateResponseShippingMethodPriceRegExp).describe('Shipping cost')
}).describe('Serializer for ShippingMethod model.'),
  "applied_coupon": zod.object({
  "id": zod.number(),
  ...
  "description": zod.string().optional(),
  "discount_amount": zod.string().regex(checkoutCartsUpdateResponseAppliedCouponDiscountAmountRegExp).describe('Fixed discount amount'),
  "valid_from": zod.string().datetime({}),
  "valid_until": zod.string().datetime({}),
...
export const checkoutCartsPartialUpdateResponse = zod.object({
  ...
  "price": zod.string().regex(checkoutCartsPartialUpdateResponseItemsItemProductPriceRegExp).describe('Product price'),
  "original_price": zod.string().regex(checkoutCartsPartialUpdateResponseItemsItemProductOriginalPriceRegExp).describe('Original price for showing discounts'),
  "current_price": zod.string().describe('Get current price as formatted decimal string.'),
  "discount_percentage": zod.number().describe('Calculate discount percentage.'),
  ...
  "description": zod.string().optional().describe('Manufacturer description'),
  "website": zod.string().url().max(checkoutCartsPartialUpdateResponseItemsItemProductManufacturerWebsiteMax).optional().describe('Manufacturer website URL'),
  "is_active": zod.boolean().optional().describe('Whether this manufacturer is visible'),
  "active_product_count": zod.number(),
  "created_at": zod.string().datetime({}).describe('Timestamp when the record was created'),
  "updated_at": zod.string().datetime({}).describe('Timestamp when the record was last updated')
  ...
  "unit_price": zod.string().regex(checkoutCartsPartialUpdateResponseItemsItemUnitPriceRegExp).describe('Price per unit when added to cart'),
  "total_price": zod.number().describe('Get total price for this item.'),
  "created_at": zod.string().datetime({}).describe('Timestamp when the record was created'),
  "updated_at": zod.string().datetime({}).describe('Timestamp when the record was last updated')
}).describe('Serializer for CartItem model.')),
  ...
  "price": zod.string().regex(checkoutCartsPartialUpdateResponseShippingMethodPriceRegExp).describe('Shipping cost')
}).describe('Serializer for ShippingMethod model.'),
  "applied_coupon": zod.object({
  "id": zod.number(),
  ...
  "description": zod.string().optional(),
  "discount_amount": zod.string().regex(checkoutCartsPartialUpdateResponseAppliedCouponDiscountAmountRegExp).describe('Fixed discount amount'),
  "valid_from": zod.string().datetime({}),
  "valid_until": zod.string().datetime({}),
...
export const checkoutCartsClearCreateResponse = zod.object({
  ...
  "price": zod.string().regex(checkoutCartsClearCreateResponseItemsItemProductPriceRegExp).describe('Product price'),
  "original_price": zod.string().regex(checkoutCartsClearCreateResponseItemsItemProductOriginalPriceRegExp).describe('Original price for showing discounts'),
  "current_price": zod.string().describe('Get current price as formatted decimal string.'),
  "discount_percentage": zod.number().describe('Calculate discount percentage.'),
  ...
  "description": zod.string().optional().describe('Manufacturer description'),
  "website": zod.string().url().max(checkoutCartsClearCreateResponseItemsItemProductManufacturerWebsiteMax).optional().describe('Manufacturer website URL'),
  "is_active": zod.boolean().optional().describe('Whether this manufacturer is visible'),
  "active_product_count": zod.number(),
  "created_at": zod.string().datetime({}).describe('Timestamp when the record was created'),
  "updated_at": zod.string().datetime({}).describe('Timestamp when the record was last updated')
  ...
  "unit_price": zod.string().regex(checkoutCartsClearCreateResponseItemsItemUnitPriceRegExp).describe('Price per unit when added to cart'),
  "total_price": zod.number().describe('Get total price for this item.'),
  "created_at": zod.string().datetime({}).describe('Timestamp when the record was created'),
  "updated_at": zod.string().datetime({}).describe('Timestamp when the record was last updated')
}).describe('Serializer for CartItem model.')),
  ...
  "price": zod.string().regex(checkoutCartsClearCreateResponseShippingMethodPriceRegExp).describe('Shipping cost')
}).describe('Serializer for ShippingMethod model.'),
  "applied_coupon": zod.object({
  "id": zod.number(),
  ...
  "description": zod.string().optional(),
  "discount_amount": zod.string().regex(checkoutCartsClearCreateResponseAppliedCouponDiscountAmountRegExp).describe('Fixed discount amount'),
  "valid_from": zod.string().datetime({}),
  "valid_until": zod.string().datetime({}),
...
export const checkoutCartsSetShippingAddressCreateResponse = zod.object({
  ...
  "price": zod.string().regex(checkoutCartsSetShippingAddressCreateResponseItemsItemProductPriceRegExp).describe('Product price'),
  "original_price": zod.string().regex(checkoutCartsSetShippingAddressCreateResponseItemsItemProductOriginalPriceRegExp).describe('Original price for showing discounts'),
  "current_price": zod.string().describe('Get current price as formatted decimal string.'),
  "discount_percentage": zod.number().describe('Calculate discount percentage.'),
  ...
  "description": zod.string().optional().describe('Manufacturer description'),
  "website": zod.string().url().max(checkoutCartsSetShippingAddressCreateResponseItemsItemProductManufacturerWebsiteMax).optional().describe('Manufacturer website URL'),
  "is_active": zod.boolean().optional().describe('Whether this manufacturer is visible'),
  "active_product_count": zod.number(),
  "created_at": zod.string().datetime({}).describe('Timestamp when the record was created'),
  "updated_at": zod.string().datetime({}).describe('Timestamp when the record was last updated')
  ...
  "unit_price": zod.string().regex(checkoutCartsSetShippingAddressCreateResponseItemsItemUnitPriceRegExp).describe('Price per unit when added to cart'),
  "total_price": zod.number().describe('Get total price for this item.'),
  "created_at": zod.string().datetime({}).describe('Timestamp when the record was created'),
  "updated_at": zod.string().datetime({}).describe('Timestamp when the record was last updated')
}).describe('Serializer for CartItem model.')),
  ...
  "price": zod.string().regex(checkoutCartsSetShippingAddressCreateResponseShippingMethodPriceRegExp).describe('Shipping cost')
}).describe('Serializer for ShippingMethod model.'),
  "applied_coupon": zod.object({
  "id": zod.number(),
  ...
  "description": zod.string().optional(),
  "discount_amount": zod.string().regex(checkoutCartsSetShippingAddressCreateResponseAppliedCouponDiscountAmountRegExp).describe('Fixed discount amount'),
  "valid_from": zod.string().datetime({}),
  "valid_until": zod.string().datetime({}),
...
export const checkoutCartsSetShippingMethodCreateResponse = zod.object({
  ...
  "price": zod.string().regex(checkoutCartsSetShippingMethodCreateResponseItemsItemProductPriceRegExp).describe('Product price'),
  "original_price": zod.string().regex(checkoutCartsSetShippingMethodCreateResponseItemsItemProductOriginalPriceRegExp).describe('Original price for showing discounts'),
  "current_price": zod.string().describe('Get current price as formatted decimal string.'),
  "discount_percentage": zod.number().describe('Calculate discount percentage.'),
  ...
  "description": zod.string().optional().describe('Manufacturer description'),
  "website": zod.string().url().max(checkoutCartsSetShippingMethodCreateResponseItemsItemProductManufacturerWebsiteMax).optional().describe('Manufacturer website URL'),
  "is_active": zod.boolean().optional().describe('Whether this manufacturer is visible'),
  "active_product_count": zod.number(),
  "created_at": zod.string().datetime({}).describe('Timestamp when the record was created'),
  "updated_at": zod.string().datetime({}).describe('Timestamp when the record was last updated')
  ...
  "unit_price": zod.string().regex(checkoutCartsSetShippingMethodCreateResponseItemsItemUnitPriceRegExp).describe('Price per unit when added to cart'),
  "total_price": zod.number().describe('Get total price for this item.'),
  "created_at": zod.string().datetime({}).describe('Timestamp when the record was created'),
  "updated_at": zod.string().datetime({}).describe('Timestamp when the record was last updated')
}).describe('Serializer for CartItem model.')),
  ...
  "price": zod.string().regex(checkoutCartsSetShippingMethodCreateResponseShippingMethodPriceRegExp).describe('Shipping cost')
}).describe('Serializer for ShippingMethod model.'),
  "applied_coupon": zod.object({
  "id": zod.number(),
  ...
  "description": zod.string().optional(),
  "discount_amount": zod.string().regex(checkoutCartsSetShippingMethodCreateResponseAppliedCouponDiscountAmountRegExp).describe('Fixed discount amount'),
  "valid_from": zod.string().datetime({}),
  "valid_until": zod.string().datetime({}),
...
export const checkoutCartsSummaryRetrieveResponse = zod.object({
  ...
  "price": zod.string().regex(checkoutCartsSummaryRetrieveResponseItemsItemProductPriceRegExp).describe('Product price'),
  "original_price": zod.string().regex(checkoutCartsSummaryRetrieveResponseItemsItemProductOriginalPriceRegExp).describe('Original price for showing discounts'),
  "current_price": zod.string().describe('Get current price as formatted decimal string.'),
  "discount_percentage": zod.number().describe('Calculate discount percentage.'),
  ...
  "description": zod.string().optional().describe('Manufacturer description'),
  "website": zod.string().url().max(checkoutCartsSummaryRetrieveResponseItemsItemProductManufacturerWebsiteMax).optional().describe('Manufacturer website URL'),
  "is_active": zod.boolean().optional().describe('Whether this manufacturer is visible'),
  "active_product_count": zod.number(),
  "created_at": zod.string().datetime({}).describe('Timestamp when the record was created'),
  "updated_at": zod.string().datetime({}).describe('Timestamp when the record was last updated')
  ...
  "unit_price": zod.string().regex(checkoutCartsSummaryRetrieveResponseItemsItemUnitPriceRegExp).describe('Price per unit when added to cart'),
  "total_price": zod.number().describe('Get total price for this item.'),
  "created_at": zod.string().datetime({}).describe('Timestamp when the record was created'),
  "updated_at": zod.string().datetime({}).describe('Timestamp when the record was last updated')
}).describe('Serializer for CartItem model.')),
  ...
  "price": zod.string().regex(checkoutCartsSummaryRetrieveResponseShippingMethodPriceRegExp).describe('Shipping cost')
}).describe('Serializer for ShippingMethod model.'),
  "applied_coupon": zod.object({
  "id": zod.number(),
  ...
  "description": zod.string().optional(),
  "discount_amount": zod.string().regex(checkoutCartsSummaryRetrieveResponseAppliedCouponDiscountAmountRegExp).describe('Fixed discount amount'),
  "valid_from": zod.string().datetime({}),
  "valid_until": zod.string().datetime({}),
...
export const checkoutCartsCurrentRetrieveResponse = zod.object({
  ...
  "price": zod.string().regex(checkoutCartsCurrentRetrieveResponseItemsItemProductPriceRegExp).describe('Product price'),
  "original_price": zod.string().regex(checkoutCartsCurrentRetrieveResponseItemsItemProductOriginalPriceRegExp).describe('Original price for showing discounts'),
  "current_price": zod.string().describe('Get current price as formatted decimal string.'),
  "discount_percentage": zod.number().describe('Calculate discount percentage.'),
  ...
  "description": zod.string().optional().describe('Manufacturer description'),
  "website": zod.string().url().max(checkoutCartsCurrentRetrieveResponseItemsItemProductManufacturerWebsiteMax).optional().describe('Manufacturer website URL'),
  "is_active": zod.boolean().optional().describe('Whether this manufacturer is visible'),
  "active_product_count": zod.number(),
  "created_at": zod.string().datetime({}).describe('Timestamp when the record was created'),
  "updated_at": zod.string().datetime({}).describe('Timestamp when the record was last updated')
  ...
  "unit_price": zod.string().regex(checkoutCartsCurrentRetrieveResponseItemsItemUnitPriceRegExp).describe('Price per unit when added to cart'),
  "total_price": zod.number().describe('Get total price for this item.'),
  "created_at": zod.string().datetime({}).describe('Timestamp when the record was created'),
  "updated_at": zod.string().datetime({}).describe('Timestamp when the record was last updated')
}).describe('Serializer for CartItem model.')),
  ...
  "price": zod.string().regex(checkoutCartsCurrentRetrieveResponseShippingMethodPriceRegExp).describe('Shipping cost')
}).describe('Serializer for ShippingMethod model.'),
  "applied_coupon": zod.object({
  "id": zod.number(),
  ...
  "description": zod.string().optional(),
  "discount_amount": zod.string().regex(checkoutCartsCurrentRetrieveResponseAppliedCouponDiscountAmountRegExp).describe('Fixed discount amount'),
  "valid_from": zod.string().datetime({}),
  "valid_until": zod.string().datetime({}),
...
export const checkoutConfirmPaymentIntentCreateResponse = zod.object({
  ...
  "message": zod.string(),
  "amount_paid": zod.string().regex(checkoutConfirmPaymentIntentCreateResponseAmountPaidRegExp),
  "currency": zod.string()
...
export const checkoutCouponRedemptionsListResponse = zod.object({
  ...
  "description": zod.string().optional(),
  "discount_amount": zod.string().regex(checkoutCouponRedemptionsListResponseResultsItemCouponDiscountAmountRegExp).describe('Fixed discount amount'),
  "valid_from": zod.string().datetime({}),
  "valid_until": zod.string().datetime({}),
  ...
  "discount_amount": zod.string().regex(checkoutCouponRedemptionsListResponseResultsItemDiscountAmountRegExp),
  "original_total": zod.string().regex(checkoutCouponRedemptionsListResponseResultsItemOriginalTotalRegExp),
  "final_total": zod.string().regex(checkoutCouponRedemptionsListResponseResultsItemFinalTotalRegExp),
  "created_at": zod.string().datetime({}).describe('Timestamp when the record was created')
...
export const checkoutCouponRedemptionsRetrieveResponse = zod.object({
  ...
  "description": zod.string().optional(),
  "discount_amount": zod.string().regex(checkoutCouponRedemptionsRetrieveResponseCouponDiscountAmountRegExp).describe('Fixed discount amount'),
  "valid_from": zod.string().datetime({}),
  "valid_until": zod.string().datetime({}),
  ...
  "discount_amount": zod.string().regex(checkoutCouponRedemptionsRetrieveResponseDiscountAmountRegExp),
  "original_total": zod.string().regex(checkoutCouponRedemptionsRetrieveResponseOriginalTotalRegExp),
  "final_total": zod.string().regex(checkoutCouponRedemptionsRetrieveResponseFinalTotalRegExp),
  "created_at": zod.string().datetime({}).describe('Timestamp when the record was created')
}).describe('Serializer for coupon redemption tracking.')
...
export const checkoutCouponsListResponse = zod.object({
  ...
  "description": zod.string().optional(),
  "discount_amount": zod.string().regex(checkoutCouponsListResponseResultsItemDiscountAmountRegExp).describe('Fixed discount amount'),
  "valid_from": zod.string().datetime({}),
  "valid_until": zod.string().datetime({}),
...
export const checkoutCouponsCreateBody = zod.object({
  ...
  "description": zod.string().optional(),
  "discount_amount": zod.string().regex(checkoutCouponsCreateBodyDiscountAmountRegExp).describe('Fixed discount amount'),
  "valid_from": zod.string().datetime({}),
  "valid_until": zod.string().datetime({}),
...
export const checkoutCouponsRetrieveResponse = zod.object({
  ...
  "description": zod.string().optional(),
  "discount_amount": zod.string().regex(checkoutCouponsRetrieveResponseDiscountAmountRegExp).describe('Fixed discount amount'),
  "valid_from": zod.string().datetime({}),
  "valid_until": zod.string().datetime({}),
...
export const checkoutCouponsUpdateBody = zod.object({
  ...
  "description": zod.string().optional(),
  "discount_amount": zod.string().regex(checkoutCouponsUpdateBodyDiscountAmountRegExp).describe('Fixed discount amount'),
  "valid_from": zod.string().datetime({}),
  "valid_until": zod.string().datetime({}),
...
export const checkoutCouponsUpdateResponse = zod.object({
  ...
  "description": zod.string().optional(),
  "discount_amount": zod.string().regex(checkoutCouponsUpdateResponseDiscountAmountRegExp).describe('Fixed discount amount'),
  "valid_from": zod.string().datetime({}),
  "valid_until": zod.string().datetime({}),
...
export const checkoutCouponsPartialUpdateBody = zod.object({
  ...
  "description": zod.string().optional(),
  "discount_amount": zod.string().regex(checkoutCouponsPartialUpdateBodyDiscountAmountRegExp).optional().describe('Fixed discount amount'),
  "valid_from": zod.string().datetime({}).optional(),
  "valid_until": zod.string().datetime({}).optional(),
...
export const checkoutCouponsPartialUpdateResponse = zod.object({
  ...
  "description": zod.string().optional(),
  "discount_amount": zod.string().regex(checkoutCouponsPartialUpdateResponseDiscountAmountRegExp).describe('Fixed discount amount'),
  "valid_from": zod.string().datetime({}),
  "valid_until": zod.string().datetime({}),
...
export const checkoutCouponsValidateCreateResponse = zod.object({
  ...
  "description": zod.string().optional(),
  "discount_amount": zod.string().regex(checkoutCouponsValidateCreateResponseCouponDiscountAmountRegExp).describe('Fixed discount amount'),
  "valid_from": zod.string().datetime({}),
  "valid_until": zod.string().datetime({}),
...
export const checkoutItemsListResponseItem = zod.object({
  ...
  "price": zod.string().regex(checkoutItemsListResponseProductPriceRegExp).describe('Product price'),
  "original_price": zod.string().regex(checkoutItemsListResponseProductOriginalPriceRegExp).describe('Original price for showing discounts'),
  "current_price": zod.string().describe('Get current price as formatted decimal string.'),
  "discount_percentage": zod.number().describe('Calculate discount percentage.'),
  ...
  "description": zod.string().optional().describe('Manufacturer description'),
  "website": zod.string().url().max(checkoutItemsListResponseProductManufacturerWebsiteMax).optional().describe('Manufacturer website URL'),
  "is_active": zod.boolean().optional().describe('Whether this manufacturer is visible'),
  "active_product_count": zod.number(),
  "created_at": zod.string().datetime({}).describe('Timestamp when the record was created'),
  "updated_at": zod.string().datetime({}).describe('Timestamp when the record was last updated')
  ...
  "unit_price": zod.string().regex(checkoutItemsListResponseUnitPriceRegExp).describe('Price per unit when added to cart'),
  "total_price": zod.number().describe('Get total price for this item.'),
  "created_at": zod.string().datetime({}).describe('Timestamp when the record was created'),
  "updated_at": zod.string().datetime({}).describe('Timestamp when the record was last updated')
}).describe('Serializer for CartItem model.')
...
export const checkoutItemsRetrieveResponse = zod.object({
  ...
  "price": zod.string().regex(checkoutItemsRetrieveResponseProductPriceRegExp).describe('Product price'),
  "original_price": zod.string().regex(checkoutItemsRetrieveResponseProductOriginalPriceRegExp).describe('Original price for showing discounts'),
  "current_price": zod.string().describe('Get current price as formatted decimal string.'),
  "discount_percentage": zod.number().describe('Calculate discount percentage.'),
  ...
  "description": zod.string().optional().describe('Manufacturer description'),
  "website": zod.string().url().max(checkoutItemsRetrieveResponseProductManufacturerWebsiteMax).optional().describe('Manufacturer website URL'),
  "is_active": zod.boolean().optional().describe('Whether this manufacturer is visible'),
  "active_product_count": zod.number(),
  "created_at": zod.string().datetime({}).describe('Timestamp when the record was created'),
  "updated_at": zod.string().datetime({}).describe('Timestamp when the record was last updated')
  ...
  "unit_price": zod.string().regex(checkoutItemsRetrieveResponseUnitPriceRegExp).describe('Price per unit when added to cart'),
  "total_price": zod.number().describe('Get total price for this item.'),
  "created_at": zod.string().datetime({}).describe('Timestamp when the record was created'),
  "updated_at": zod.string().datetime({}).describe('Timestamp when the record was last updated')
}).describe('Serializer for CartItem model.')
...
export const checkoutItemsUpdateResponse = zod.object({
  ...
  "price": zod.string().regex(checkoutItemsUpdateResponseProductPriceRegExp).describe('Product price'),
  "original_price": zod.string().regex(checkoutItemsUpdateResponseProductOriginalPriceRegExp).describe('Original price for showing discounts'),
  "current_price": zod.string().describe('Get current price as formatted decimal string.'),
  "discount_percentage": zod.number().describe('Calculate discount percentage.'),
  ...
  "description": zod.string().optional().describe('Manufacturer description'),
  "website": zod.string().url().max(checkoutItemsUpdateResponseProductManufacturerWebsiteMax).optional().describe('Manufacturer website URL'),
  "is_active": zod.boolean().optional().describe('Whether this manufacturer is visible'),
  "active_product_count": zod.number(),
  "created_at": zod.string().datetime({}).describe('Timestamp when the record was created'),
  "updated_at": zod.string().datetime({}).describe('Timestamp when the record was last updated')
  ...
  "unit_price": zod.string().regex(checkoutItemsUpdateResponseUnitPriceRegExp).describe('Price per unit when added to cart'),
  "total_price": zod.number().describe('Get total price for this item.'),
  "created_at": zod.string().datetime({}).describe('Timestamp when the record was created'),
  "updated_at": zod.string().datetime({}).describe('Timestamp when the record was last updated')
}).describe('Serializer for CartItem model.')
...
export const checkoutItemsPartialUpdateResponse = zod.object({
  ...
  "price": zod.string().regex(checkoutItemsPartialUpdateResponseProductPriceRegExp).describe('Product price'),
  "original_price": zod.string().regex(checkoutItemsPartialUpdateResponseProductOriginalPriceRegExp).describe('Original price for showing discounts'),
  "current_price": zod.string().describe('Get current price as formatted decimal string.'),
  "discount_percentage": zod.number().describe('Calculate discount percentage.'),
  ...
  "description": zod.string().optional().describe('Manufacturer description'),
  "website": zod.string().url().max(checkoutItemsPartialUpdateResponseProductManufacturerWebsiteMax).optional().describe('Manufacturer website URL'),
  "is_active": zod.boolean().optional().describe('Whether this manufacturer is visible'),
  "active_product_count": zod.number(),
  "created_at": zod.string().datetime({}).describe('Timestamp when the record was created'),
  "updated_at": zod.string().datetime({}).describe('Timestamp when the record was last updated')
  ...
  "unit_price": zod.string().regex(checkoutItemsPartialUpdateResponseUnitPriceRegExp).describe('Price per unit when added to cart'),
  "total_price": zod.number().describe('Get total price for this item.'),
  "created_at": zod.string().datetime({}).describe('Timestamp when the record was created'),
  "updated_at": zod.string().datetime({}).describe('Timestamp when the record was last updated')
}).describe('Serializer for CartItem model.')
...
export const checkoutItemsDecreaseQuantityCreateResponse = zod.object({
  ...
  "price": zod.string().regex(checkoutItemsDecreaseQuantityCreateResponseProductPriceRegExp).describe('Product price'),
  "original_price": zod.string().regex(checkoutItemsDecreaseQuantityCreateResponseProductOriginalPriceRegExp).describe('Original price for showing discounts'),
  "current_price": zod.string().describe('Get current price as formatted decimal string.'),
  "discount_percentage": zod.number().describe('Calculate discount percentage.'),
  ...
  "description": zod.string().optional().describe('Manufacturer description'),
  "website": zod.string().url().max(checkoutItemsDecreaseQuantityCreateResponseProductManufacturerWebsiteMax).optional().describe('Manufacturer website URL'),
  "is_active": zod.boolean().optional().describe('Whether this manufacturer is visible'),
  "active_product_count": zod.number(),
  "created_at": zod.string().datetime({}).describe('Timestamp when the record was created'),
  "updated_at": zod.string().datetime({}).describe('Timestamp when the record was last updated')
  ...
  "unit_price": zod.string().regex(checkoutItemsDecreaseQuantityCreateResponseUnitPriceRegExp).describe('Price per unit when added to cart'),
  "total_price": zod.number().describe('Get total price for this item.'),
  "created_at": zod.string().datetime({}).describe('Timestamp when the record was created'),
  "updated_at": zod.string().datetime({}).describe('Timestamp when the record was last updated')
}).describe('Serializer for CartItem model.')
...
export const checkoutItemsIncreaseQuantityCreateResponse = zod.object({
  ...
  "price": zod.string().regex(checkoutItemsIncreaseQuantityCreateResponseProductPriceRegExp).describe('Product price'),
  "original_price": zod.string().regex(checkoutItemsIncreaseQuantityCreateResponseProductOriginalPriceRegExp).describe('Original price for showing discounts'),
  "current_price": zod.string().describe('Get current price as formatted decimal string.'),
  "discount_percentage": zod.number().describe('Calculate discount percentage.'),
  ...
  "description": zod.string().optional().describe('Manufacturer description'),
  "website": zod.string().url().max(checkoutItemsIncreaseQuantityCreateResponseProductManufacturerWebsiteMax).optional().describe('Manufacturer website URL'),
  "is_active": zod.boolean().optional().describe('Whether this manufacturer is visible'),
  "active_product_count": zod.number(),
  "created_at": zod.string().datetime({}).describe('Timestamp when the record was created'),
  "updated_at": zod.string().datetime({}).describe('Timestamp when the record was last updated')
  ...
  "unit_price": zod.string().regex(checkoutItemsIncreaseQuantityCreateResponseUnitPriceRegExp).describe('Price per unit when added to cart'),
  "total_price": zod.number().describe('Get total price for this item.'),
  "created_at": zod.string().datetime({}).describe('Timestamp when the record was created'),
  "updated_at": zod.string().datetime({}).describe('Timestamp when the record was last updated')
}).describe('Serializer for CartItem model.')
...
export const checkoutItemsUpdateQuantityCreateResponse = zod.object({
  ...
  "price": zod.string().regex(checkoutItemsUpdateQuantityCreateResponseProductPriceRegExp).describe('Product price'),
  "original_price": zod.string().regex(checkoutItemsUpdateQuantityCreateResponseProductOriginalPriceRegExp).describe('Original price for showing discounts'),
  "current_price": zod.string().describe('Get current price as formatted decimal string.'),
  "discount_percentage": zod.number().describe('Calculate discount percentage.'),
  ...
  "description": zod.string().optional().describe('Manufacturer description'),
  "website": zod.string().url().max(checkoutItemsUpdateQuantityCreateResponseProductManufacturerWebsiteMax).optional().describe('Manufacturer website URL'),
  "is_active": zod.boolean().optional().describe('Whether this manufacturer is visible'),
  "active_product_count": zod.number(),
  "created_at": zod.string().datetime({}).describe('Timestamp when the record was created'),
  "updated_at": zod.string().datetime({}).describe('Timestamp when the record was last updated')
  ...
  "unit_price": zod.string().regex(checkoutItemsUpdateQuantityCreateResponseUnitPriceRegExp).describe('Price per unit when added to cart'),
  "total_price": zod.number().describe('Get total price for this item.'),
  "created_at": zod.string().datetime({}).describe('Timestamp when the record was created'),
  "updated_at": zod.string().datetime({}).describe('Timestamp when the record was last updated')
}).describe('Serializer for CartItem model.')
...
export const checkoutOrdersListResponse = zod.object({
  ...
  "subtotal": zod.string().regex(checkoutOrdersListResponseResultsItemOrdersItemSubtotalRegExp).describe('Subtotal of all items'),
  "shipping_cost": zod.string().regex(checkoutOrdersListResponseResultsItemOrdersItemShippingCostRegExp).optional().describe('Shipping cost'),
  "coupon_discount": zod.string().regex(checkoutOrdersListResponseResultsItemOrdersItemCouponDiscountRegExp).optional().describe('Discount amount from applied coupon'),
  "total": zod.string().regex(checkoutOrdersListResponseResultsItemOrdersItemTotalRegExp).describe('Total amount including shipping'),
  "created_at": zod.string().datetime({}).describe('Timestamp when the record was created')
...
export const checkoutOrdersRetrieveResponseItemsItemProductImagesItemAltTextMax = 255;
...
export const checkoutOrdersRetrieveResponse = zod.object({
  ...
  "status": zod.enum(['pending', 'confirmed', 'shipped', 'delivered']).describe('* `pending` - Pending\n* `confirmed` - Confirmed\n* `shipped` - Shipped\n* `delivered` - Delivered'),
  "subtotal": zod.string().regex(checkoutOrdersRetrieveResponseSubtotalRegExp).describe('Subtotal of all items'),
  "shipping_cost": zod.string().regex(checkoutOrdersRetrieveResponseShippingCostRegExp),
  "coupon_discount": zod.string().regex(checkoutOrdersRetrieveResponseCouponDiscountRegExp).optional().describe('Discount amount from applied coupon'),
  "total": zod.string().regex(checkoutOrdersRetrieveResponseTotalRegExp).describe('Total amount including shipping'),
  "created_at": zod.string().datetime({}).describe('Timestamp when the record was created'),
  ...
  "price": zod.string().regex(checkoutOrdersRetrieveResponseShippingMethodPriceRegExp).describe('Shipping cost')
}).describe('Serializer for ShippingMethod model.'),
  "applied_coupon": zod.object({
  "id": zod.number(),
  ...
  "description": zod.string().optional(),
  "discount_amount": zod.string().regex(checkoutOrdersRetrieveResponseAppliedCouponDiscountAmountRegExp).describe('Fixed discount amount'),
  "valid_from": zod.string().datetime({}),
  "valid_until": zod.string().datetime({}),
  ...
  "price": zod.string().regex(checkoutOrdersRetrieveResponseItemsItemProductPriceRegExp).describe('Product price'),
  "original_price": zod.string().regex(checkoutOrdersRetrieveResponseItemsItemProductOriginalPriceRegExp).describe('Original price for showing discounts'),
  "current_price": zod.string().describe('Get current price as formatted decimal string.'),
  "discount_percentage": zod.number().describe('Calculate discount percentage.'),
  ...
  "description": zod.string().optional().describe('Manufacturer description'),
  "website": zod.string().url().max(checkoutOrdersRetrieveResponseItemsItemProductManufacturerWebsiteMax).optional().describe('Manufacturer website URL'),
  "is_active": zod.boolean().optional().describe('Whether this manufacturer is visible'),
  "active_product_count": zod.number(),
  "created_at": zod.string().datetime({}).describe('Timestamp when the record was created'),
  "updated_at": zod.string().datetime({}).describe('Timestamp when the record was last updated')
  ...
  "unit_price": zod.string().regex(checkoutOrdersRetrieveResponseItemsItemUnitPriceRegExp).describe('Price per unit at time of order'),
...
export const checkoutPaymentsListResponse = zod.object({
  ...
  "results": zod.array(zod.object({
  "id": zod.number(),
  "amount": zod.string().regex(checkoutPaymentsListResponseResultsItemAmountRegExp),
...
export const checkoutPaymentsCreateBody = zod.object({
  "amount": zod.string().regex(checkoutPaymentsCreateBodyAmountRegExp),
  "status": zod.enum(['pending', 'completed', 'failed', 'canceled']).describe('* `pending` - Pending\n* `completed` - Completed\n* `failed` - Failed\n* `canceled` - Canceled').optional().describe('Current status of the payment\n\n* `pending` - Pending\n* `completed` - Completed\n* `failed` - Failed\n* `canceled` - Canceled'),
...
export const checkoutPaymentsRetrieveResponse = zod.object({
  "id": zod.number(),
  "amount": zod.string().regex(checkoutPaymentsRetrieveResponseAmountRegExp),
  "status": zod.enum(['pending', 'completed', 'failed', 'canceled']).describe('* `pending` - Pending\n* `completed` - Completed\n* `failed` - Failed\n* `canceled` - Canceled').optional().describe('Current status of the payment\n\n* `pending` - Pending\n* `completed` - Completed\n* `failed` - Failed\n* `canceled` - Canceled'),
...
export const checkoutPaymentsUpdateBody = zod.object({
  "amount": zod.string().regex(checkoutPaymentsUpdateBodyAmountRegExp),
  "status": zod.enum(['pending', 'completed', 'failed', 'canceled']).describe('* `pending` - Pending\n* `completed` - Completed\n* `failed` - Failed\n* `canceled` - Canceled').optional().describe('Current status of the payment\n\n* `pending` - Pending\n* `completed` - Completed\n* `failed` - Failed\n* `canceled` - Canceled'),
...
export const checkoutPaymentsUpdateResponse = zod.object({
  "id": zod.number(),
  "amount": zod.string().regex(checkoutPaymentsUpdateResponseAmountRegExp),
  "status": zod.enum(['pending', 'completed', 'failed', 'canceled']).describe('* `pending` - Pending\n* `completed` - Completed\n* `failed` - Failed\n* `canceled` - Canceled').optional().describe('Current status of the payment\n\n* `pending` - Pending\n* `completed` - Completed\n* `failed` - Failed\n* `canceled` - Canceled'),
...
export const checkoutPaymentsPartialUpdateBody = zod.object({
  "amount": zod.string().regex(checkoutPaymentsPartialUpdateBodyAmountRegExp).optional(),
  "status": zod.enum(['pending', 'completed', 'failed', 'canceled']).describe('* `pending` - Pending\n* `completed` - Completed\n* `failed` - Failed\n* `canceled` - Canceled').optional().describe('Current status of the payment\n\n* `pending` - Pending\n* `completed` - Completed\n* `failed` - Failed\n* `canceled` - Canceled'),
...
export const checkoutPaymentsPartialUpdateResponse = zod.object({
  "id": zod.number(),
  "amount": zod.string().regex(checkoutPaymentsPartialUpdateResponseAmountRegExp),
  "status": zod.enum(['pending', 'completed', 'failed', 'canceled']).describe('* `pending` - Pending\n* `completed` - Completed\n* `failed` - Failed\n* `canceled` - Canceled').optional().describe('Current status of the payment\n\n* `pending` - Pending\n* `completed` - Completed\n* `failed` - Failed\n* `canceled` - Canceled'),
...
export const checkoutShipmentsListResponse = zod.object({
  ...
  "shipped_at": zod.string().datetime({}).describe('When the package was shipped'),
  "delivered_at": zod.string().datetime({}).nullish().describe('When the package was delivered'),
...
export const checkoutShipmentsPartialUpdateBody = zod.object({
  ...
  "shipped_at": zod.string().datetime({}).optional().describe('When the package was shipped'),
  "delivered_at": zod.string().datetime({}).nullish().describe('When the package was delivered'),
...
export const checkoutShippingMethodsListResponseItem = zod.object({
  ...
  "price": zod.string().regex(checkoutShippingMethodsListResponsePriceRegExp).describe('Shipping cost')
}).describe('Serializer for ShippingMethod model.')
...
export const checkoutShippingMethodsUpdateBody = zod.object({
  ...
  "price": zod.string().regex(checkoutShippingMethodsUpdateBodyPriceRegExp).describe('Shipping cost')
}).describe('Serializer for ShippingMethod model.')
...
export const checkoutShippingMethodsPartialUpdateBody = zod.object({
  ...
  "price": zod.string().regex(checkoutShippingMethodsPartialUpdateBodyPriceRegExp).optional().describe('Shipping cost')
}).describe('Serializer for ShippingMethod model.')
