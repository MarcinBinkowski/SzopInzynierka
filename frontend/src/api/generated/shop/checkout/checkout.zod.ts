...
export const checkoutCouponRedemptionsCreateBody = zod.object({
  "discount_amount": zod.string().regex(checkoutCouponRedemptionsCreateBodyDiscountAmountRegExp),
  "original_total": zod.string().regex(checkoutCouponRedemptionsCreateBodyOriginalTotalRegExp),
  "final_total": zod.string().regex(checkoutCouponRedemptionsCreateBodyFinalTotalRegExp)
}).describe('Serializer for coupon redemption tracking.')
...
export const checkoutCouponRedemptionsUpdateBody = zod.object({
  "discount_amount": zod.string().regex(checkoutCouponRedemptionsUpdateBodyDiscountAmountRegExp),
  "original_total": zod.string().regex(checkoutCouponRedemptionsUpdateBodyOriginalTotalRegExp),
  "final_total": zod.string().regex(checkoutCouponRedemptionsUpdateBodyFinalTotalRegExp)
}).describe('Serializer for coupon redemption tracking.')
...
export const checkoutCouponRedemptionsUpdateResponse = zod.object({
  ...
  "description": zod.string().optional(),
  "discount_amount": zod.string().regex(checkoutCouponRedemptionsUpdateResponseCouponDiscountAmountRegExp).describe('Fixed discount amount'),
  "valid_from": zod.string().datetime({}),
  "valid_until": zod.string().datetime({}),
  ...
  "discount_amount": zod.string().regex(checkoutCouponRedemptionsUpdateResponseDiscountAmountRegExp),
  "original_total": zod.string().regex(checkoutCouponRedemptionsUpdateResponseOriginalTotalRegExp),
  "final_total": zod.string().regex(checkoutCouponRedemptionsUpdateResponseFinalTotalRegExp),
  "created_at": zod.string().datetime({}).describe('Timestamp when the record was created')
}).describe('Serializer for coupon redemption tracking.')
...
export const checkoutCouponRedemptionsPartialUpdateBody = zod.object({
  "discount_amount": zod.string().regex(checkoutCouponRedemptionsPartialUpdateBodyDiscountAmountRegExp).optional(),
  "original_total": zod.string().regex(checkoutCouponRedemptionsPartialUpdateBodyOriginalTotalRegExp).optional(),
  "final_total": zod.string().regex(checkoutCouponRedemptionsPartialUpdateBodyFinalTotalRegExp).optional()
}).describe('Serializer for coupon redemption tracking.')
...
export const checkoutCouponRedemptionsPartialUpdateResponse = zod.object({
  ...
  "description": zod.string().optional(),
  "discount_amount": zod.string().regex(checkoutCouponRedemptionsPartialUpdateResponseCouponDiscountAmountRegExp).describe('Fixed discount amount'),
  "valid_from": zod.string().datetime({}),
  "valid_until": zod.string().datetime({}),
  ...
  "discount_amount": zod.string().regex(checkoutCouponRedemptionsPartialUpdateResponseDiscountAmountRegExp),
  "original_total": zod.string().regex(checkoutCouponRedemptionsPartialUpdateResponseOriginalTotalRegExp),
  "final_total": zod.string().regex(checkoutCouponRedemptionsPartialUpdateResponseFinalTotalRegExp),
  "created_at": zod.string().datetime({}).describe('Timestamp when the record was created')
}).describe('Serializer for coupon redemption tracking.')
...
export const checkoutCouponsRemoveCreateResponse = zod.object({
  ...
  "description": zod.string().optional(),
  "discount_amount": zod.string().regex(checkoutCouponsRemoveCreateResponseDiscountAmountRegExp).describe('Fixed discount amount'),
  "valid_from": zod.string().datetime({}),
  "valid_until": zod.string().datetime({}),
...
export const checkoutDashboardRetrieveResponse = zod.object({
  ...
  "revenue": zod.string().regex(checkoutDashboardRetrieveResponseRevenueRegExp),
  "avg_order": zod.string().regex(checkoutDashboardRetrieveResponseAvgOrderRegExp),
  ...
  "name": zod.string(),
  "qty": zod.number(),
  "revenue": zod.string().regex(checkoutDashboardRetrieveResponseProductsEntriesItemRevenueRegExp)
})),
  "totalQty": zod.number()
}),
...
export const checkoutOrdersListResponse = zod.object({
  ...
  "subtotal": zod.string().regex(checkoutOrdersListResponseResultsItemResultsItemSubtotalRegExp).describe('Subtotal of all items'),
  "shipping_cost": zod.string().regex(checkoutOrdersListResponseResultsItemResultsItemShippingCostRegExp).optional().describe('Shipping cost'),
  "coupon_discount": zod.string().regex(checkoutOrdersListResponseResultsItemResultsItemCouponDiscountRegExp).optional().describe('Discount amount from applied coupon'),
  "total": zod.string().regex(checkoutOrdersListResponseResultsItemResultsItemTotalRegExp).describe('Total amount including shipping'),
  "created_at": zod.string().datetime({}).describe('Timestamp when the record was created')
...
export const checkoutShipmentsListResponse = zod.object({
  ...
  "order_user_email": zod.string().email(),
  "shipping_method": zod.string(),
  "courier": zod.string(),
  "shipped_at": zod.string().datetime({}).nullish().describe('When the package was shipped'),
