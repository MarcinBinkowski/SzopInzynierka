...
import type {
  CatalogWishlistFilteredRetrieveParams,
  PatchedWishlistItem,
  WishlistCheck,
  WishlistItem,
  WishlistItemCreate
...
export const catalogWishlistList = (
 ...
 signal?: AbortSignal
      ...
      {url: `/api/catalog/wishlist/`, method: 'GET', signal
    },
      );
    }
  

export const getCatalogWishlistListQueryKey = () => {
    return [`/api/catalog/wishlist/`] as const;
    }

    
export const getCatalogWishlistListQueryOptions = <TData = Awaited<ReturnType<typeof catalogWishlistList>>, TError = ErrorType<unknown>>( options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof catalogWishlistList>>, TError, TData>>, }
) => {

const {query: queryOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getCatalogWishlistListQueryKey();

  

    const queryFn: QueryFunction<Awaited<ReturnType<typeof catalogWishlistList>>> = ({ signal }) => catalogWishlistList(signal);
...
export function useCatalogWishlistList<TData = Awaited<ReturnType<typeof catalogWishlistList>>, TError = ErrorType<unknown>>(
  options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof catalogWishlistList>>, TError, TData>> & Pick<
        DefinedInitialDataOptions<
...
export function useCatalogWishlistList<TData = Awaited<ReturnType<typeof catalogWishlistList>>, TError = ErrorType<unknown>>(
  options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof catalogWishlistList>>, TError, TData>>, }
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
...
export function useCatalogWishlistList<TData = Awaited<ReturnType<typeof catalogWishlistList>>, TError = ErrorType<unknown>>(
 ...
 , queryClient?: QueryClient 
  ...
  const queryOptions = getCatalogWishlistListQueryOptions(options)
 ...
 */
export const catalogWishlistFilteredRetrieve = (
    params?: CatalogWishlistFilteredRetrieveParams,
 signal?: AbortSignal
) => {
      
      
      return shopInstance<WishlistItem>(
      {url: `/api/catalog/wishlist/filtered/`, method: 'GET',
        params, signal
    },
      );
    }
...
export const getCatalogWishlistFilteredRetrieveQueryKey = (params?: CatalogWishlistFilteredRetrieveParams,) => {
    return [`/api/catalog/wishlist/filtered/`, ...(params ? [params]: [])] as const;
    }

    
export const getCatalogWishlistFilteredRetrieveQueryOptions = <TData = Awaited<ReturnType<typeof catalogWishlistFilteredRetrieve>>, TError = ErrorType<unknown>>(params?: CatalogWishlistFilteredRetrieveParams, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof catalogWishlistFilteredRetrieve>>, TError, TData>>, }
) => {

const {query: queryOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getCatalogWishlistFilteredRetrieveQueryKey(params);

  

    const queryFn: QueryFunction<Awaited<ReturnType<typeof catalogWishlistFilteredRetrieve>>> = ({ signal }) => catalogWishlistFilteredRetrieve(params, signal);

      

      

   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof catalogWishlistFilteredRetrieve>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}

export type CatalogWishlistFilteredRetrieveQueryResult = NonNullable<Awaited<ReturnType<typeof catalogWishlistFilteredRetrieve>>>
export type CatalogWishlistFilteredRetrieveQueryError = ErrorType<unknown>


export function useCatalogWishlistFilteredRetrieve<TData = Awaited<ReturnType<typeof catalogWishlistFilteredRetrieve>>, TError = ErrorType<unknown>>(
 params: undefined |  CatalogWishlistFilteredRetrieveParams, options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof catalogWishlistFilteredRetrieve>>, TError, TData>> & Pick<
        DefinedInitialDataOptions<
          Awaited<ReturnType<typeof catalogWishlistFilteredRetrieve>>,
          TError,
          Awaited<ReturnType<typeof catalogWishlistFilteredRetrieve>>
        > , 'initialData'
      >, }
...
export function useCatalogWishlistFilteredRetrieve<TData = Awaited<ReturnType<typeof catalogWishlistFilteredRetrieve>>, TError = ErrorType<unknown>>(
 params?: CatalogWishlistFilteredRetrieveParams, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof catalogWishlistFilteredRetrieve>>, TError, TData>> & Pick<
        UndefinedInitialDataOptions<
          Awaited<ReturnType<typeof catalogWishlistFilteredRetrieve>>,
          TError,
          Awaited<ReturnType<typeof catalogWishlistFilteredRetrieve>>
...
export function useCatalogWishlistFilteredRetrieve<TData = Awaited<ReturnType<typeof catalogWishlistFilteredRetrieve>>, TError = ErrorType<unknown>>(
 params?: CatalogWishlistFilteredRetrieveParams, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof catalogWishlistFilteredRetrieve>>, TError, TData>>, }
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
...
export function useCatalogWishlistFilteredRetrieve<TData = Awaited<ReturnType<typeof catalogWishlistFilteredRetrieve>>, TError = ErrorType<unknown>>(
 ...
 , queryClient?: QueryClient 
  ...
  const queryOptions = getCatalogWishlistFilteredRetrieveQueryOptions(params,options)
