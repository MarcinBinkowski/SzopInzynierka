 ...
 */
export const getAllauthClientV1AccountEmailParams = zod.object({
  "client": zod.enum(['app', 'browser']).describe('The type of client accessing the API.')
})

export const getAllauthClientV1AccountEmailHeader = zod.object({
  "X-Session-Token": zod.string().optional().describe('Session token. Only needed when `client` is equal to `app`.\n')
})

export const getAllauthClientV1AccountEmailResponse = zod.object({
 ...
 */
export const postAllauthClientV1AccountEmailParams = zod.object({
  "client": zod.enum(['app', 'browser']).describe('The type of client accessing the API.')
})

export const postAllauthClientV1AccountEmailHeader = zod.object({
  "X-Session-Token": zod.string().optional().describe('Session token. Only needed when `client` is equal to `app`.\n')
})

export const postAllauthClientV1AccountEmailBody = zod.object({
  "email": zod.string().describe('An email address.\n')
})

export const postAllauthClientV1AccountEmailResponse = zod.object({
  "status": zod.literal(200),
  "data": zod.array(zod.object({
  "email": zod.string().describe('The email address.\n'),
  "primary": zod.boolean(),
 ...
 */
export const putAllauthClientV1AccountEmailParams = zod.object({
  "client": zod.enum(['app', 'browser']).describe('The type of client accessing the API.')
})

export const putAllauthClientV1AccountEmailHeader = zod.object({
  "X-Session-Token": zod.string().optional().describe('Session token. Only needed when `client` is equal to `app`.\n')
})

export const putAllauthClientV1AccountEmailBody = zod.object({
  "email": zod.string().describe('An email address.\n')
})

export const putAllauthClientV1AccountEmailResponse = zod.object({
  "status": zod.literal(200)
})
 ...
 */
export const patchAllauthClientV1AccountEmailParams = zod.object({
  "client": zod.enum(['app', 'browser']).describe('The type of client accessing the API.')
})

export const patchAllauthClientV1AccountEmailHeader = zod.object({
  "X-Session-Token": zod.string().optional().describe('Session token. Only needed when `client` is equal to `app`.\n')
})

export const patchAllauthClientV1AccountEmailBody = zod.object({
  "email": zod.string().describe('An email address.\n'),
  "primary": zod.literal(true).describe('Primary flag.\n')
})

export const patchAllauthClientV1AccountEmailResponse = zod.object({
  "status": zod.literal(200),
  "data": zod.array(zod.object({
  "email": zod.string().describe('The email address.\n'),
  "primary": zod.boolean(),
 ...
 */
export const deleteAllauthClientV1AccountEmailParams = zod.object({
  "client": zod.enum(['app', 'browser']).describe('The type of client accessing the API.')
})

export const deleteAllauthClientV1AccountEmailHeader = zod.object({
  "X-Session-Token": zod.string().optional().describe('Session token. Only needed when `client` is equal to `app`.\n')
})

export const deleteAllauthClientV1AccountEmailBody = zod.object({
  "email": zod.string().describe('An email address.\n')
})

export const deleteAllauthClientV1AccountEmailResponse = zod.object({
  "status": zod.literal(200),
  "data": zod.array(zod.object({
  "email": zod.string().describe('The email address.\n'),
  "primary": zod.boolean(),
