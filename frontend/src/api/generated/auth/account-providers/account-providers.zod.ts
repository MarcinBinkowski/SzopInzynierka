 ...
 */
export const getAllauthClientV1AccountProvidersParams = zod.object({
  "client": zod.enum(['app', 'browser']).describe('The type of client accessing the API.')
})

export const getAllauthClientV1AccountProvidersHeader = zod.object({
  "X-Session-Token": zod.string().optional().describe('Session token. Only needed when `client` is equal to `app`.\n')
})

export const getAllauthClientV1AccountProvidersResponse = zod.object({
 ...
 */
export const deleteAllauthClientV1AccountProvidersParams = zod.object({
  "client": zod.enum(['app', 'browser']).describe('The type of client accessing the API.')
})

export const deleteAllauthClientV1AccountProvidersHeader = zod.object({
  "X-Session-Token": zod.string().optional().describe('Session token. Only needed when `client` is equal to `app`.\n')
})

export const deleteAllauthClientV1AccountProvidersBody = zod.object({
  "provider": zod.string().describe('The provider ID.\n'),
  "account": zod.string().describe('The provider specific account ID.\n')
})

export const deleteAllauthClientV1AccountProvidersResponse = zod.object({
  "status": zod.literal(200),
  "data": zod.array(zod.object({
  "uid": zod.string().describe('The provider specific account ID.\n'),
  "display": zod.string().describe('A name derived from the third-party provider account data.\n'),
