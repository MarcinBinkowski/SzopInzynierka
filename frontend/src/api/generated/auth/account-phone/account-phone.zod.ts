 ...
 */
export const getAllauthClientV1AccountPhoneParams = zod.object({
  "client": zod.enum(['app', 'browser']).describe('The type of client accessing the API.')
})

export const getAllauthClientV1AccountPhoneHeader = zod.object({
  "X-Session-Token": zod.string().optional().describe('Session token. Only needed when `client` is equal to `app`.\n')
})

export const getAllauthClientV1AccountPhoneResponse = zod.object({
 ...
 */
export const postAllauthClientV1AccountPhoneParams = zod.object({
  "client": zod.enum(['app', 'browser']).describe('The type of client accessing the API.')
})

export const postAllauthClientV1AccountPhoneHeader = zod.object({
  "X-Session-Token": zod.string().optional().describe('Session token. Only needed when `client` is equal to `app`.\n')
})

export const postAllauthClientV1AccountPhoneBody = zod.object({
  "phone": zod.string()
})
