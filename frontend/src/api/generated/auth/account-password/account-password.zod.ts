 ...
 */
export const postAllauthClientV1AccountPasswordChangeParams = zod.object({
  "client": zod.enum(['app', 'browser']).describe('The type of client accessing the API.')
})

export const postAllauthClientV1AccountPasswordChangeHeader = zod.object({
  "X-Session-Token": zod.string().optional().describe('Session token. Only needed when `client` is equal to `app`.\n')
})

export const postAllauthClientV1AccountPasswordChangeBody = zod.object({
