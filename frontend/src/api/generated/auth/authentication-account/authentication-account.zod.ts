...
export const postAllauthClientV1AuthLoginBody = zod.object({
 ...
 */
export const postAllauthClientV1AuthEmailVerifyResendParams = zod.object({
  "client": zod.enum(['app', 'browser']).describe('The type of client accessing the API.')
})

export const postAllauthClientV1AuthEmailVerifyResendHeader = zod.object({
  "X-Session-Token": zod.string().optional().describe('Session token. Only needed when `client` is equal to `app`.\n')
})

export const postAllauthClientV1AuthEmailVerifyResendResponse = zod.object({
  "status": zod.literal(200)
})
 ...
 */
export const postAllauthClientV1AuthPhoneVerifyParams = zod.object({
  "client": zod.enum(['app', 'browser']).describe('The type of client accessing the API.')
})

export const postAllauthClientV1AuthPhoneVerifyHeader = zod.object({
  "X-Session-Token": zod.string().optional().describe('Session token. Only needed when `client` is equal to `app`.\n')
})

export const postAllauthClientV1AuthPhoneVerifyBody = zod.object({
  "code": zod.string().describe('The phone verification code')
})

export const postAllauthClientV1AuthPhoneVerifyResponse = zod.object({
  "status": zod.literal(200),
  "data": zod.object({
  "user": zod.object({
  "id": zod.number().or(zod.string()).optional().describe('The user ID.\n'),
 ...
 */
export const postAllauthClientV1AuthPhoneVerifyResendParams = zod.object({
  "client": zod.enum(['app', 'browser']).describe('The type of client accessing the API.')
})

export const postAllauthClientV1AuthPhoneVerifyResendHeader = zod.object({
  "X-Session-Token": zod.string().optional().describe('Session token. Only needed when `client` is equal to `app`.\n')
})

export const postAllauthClientV1AuthPhoneVerifyResendResponse = zod.object({
  "status": zod.literal(200)
})
