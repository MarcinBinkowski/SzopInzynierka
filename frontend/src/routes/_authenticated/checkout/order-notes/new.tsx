...
import { OrderProcessingNoteForm, type OrderNoteFormData } from "@/components/order-notes/OrderProcessingNoteForm"
...
export const Route = createFileRoute('/_authenticated/checkout/order-notes/new')({
