...
export const Route = createFileRoute('/_authenticated/checkout/coupons/$couponId/edit')({
  component: EditCouponPage,
})

function EditCouponPage() {
  const navigate = useNavigate()
  const { couponId } = useParams({ from: '/_authenticated/checkout/coupons/$couponId/edit' })
  
  const { data: coupon, isLoading, error } = useCheckoutCouponsRetrieve(parseInt(couponId))
