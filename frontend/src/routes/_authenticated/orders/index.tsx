...
import { createDateColumn, createStatusColumn, createPriceColumn } from "@/components/common/listPageHelpers/columnHelpers"
...
function OrdersPage() {
  ...
  // Create a wrapper hook that matches the expected signature
