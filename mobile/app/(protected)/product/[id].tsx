...
import { useCheckoutItemsCreate, useCheckoutItemsDecreaseQuantityCreate, useCheckoutItemsIncreaseQuantityCreate, useCheckoutItemsList, getCheckoutCartsCurrentRetrieveQueryKey } from '@/api/generated/shop/checkout/checkout';
...
export default function ProductDetailScreen() {
  ...
  const { data: cartItems, refetch: refetchCartItems } = useCheckoutItemsList(undefined, { 
  ...
  const addToCartMutation = useCheckoutItemsCreate({
    mutation: {
      onSuccess: () => {
        refetchCartItems();
        queryClient.invalidateQueries({ queryKey: getCheckoutCartsCurrentRetrieveQueryKey() });
      }
    },
  });
