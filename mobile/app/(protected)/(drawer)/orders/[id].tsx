          ...
          <Card.Content>
            <View style={styles.orderHeader}>
              <View style={styles.orderInfo}>
                ...
                <Text variant="bodyMedium" style={[styles.orderDate, { color: theme.colors.onSurfaceVariant }]}>
              ...
              order.items.map((item, index) => (
                <View key={item.id}>
                  <List.Item
                    ...
                    description={`$${parseFloat(item.unit_price).toFixed(2)} x ${item.quantity}`}
        ...
        <Card style={styles.card}>
          ...
          <Card.Content>
            <View style={styles.summaryRow}>
              ...
              <Text variant="bodyMedium">${parseFloat(order.subtotal).toFixed(2)}</Text>
            </View>
            <View style={styles.summaryRow}>
              <Text variant="bodyMedium">Shipping:</Text>
              <Text variant="bodyMedium">${parseFloat(order.shipping_cost).toFixed(2)}</Text>
            </View>
          ...
          <Card.Content>
            {order.shipping_address && (
              <View style={styles.infoSection}>
                <Text variant="labelLarge" style={styles.infoLabel}>Address:</Text>
                <Text variant="bodyMedium">{order.shipping_address.full_address}</Text>
              </View>
            )}
            {order.shipping_method && (
              <View style={styles.infoSection}>
                <Text variant="labelLarge" style={styles.infoLabel}>Method:</Text>
