...
import { useProfileProfilesMePartialUpdate } from '@/api/generated/shop/profile/profile';
    ...
    <SafeAreaView style={{ flex: 1, padding: 10 }}>
      <Card>
        <Card.Content>
          ...
          />
          {errors.firstName && <Text style={{ color: 'red', marginBottom: 8 }}>{errors.firstName.message}</Text>}
          ...
          />
          {errors.lastName && <Text style={{ color: 'red', marginBottom: 8 }}>{errors.lastName.message}</Text>}
