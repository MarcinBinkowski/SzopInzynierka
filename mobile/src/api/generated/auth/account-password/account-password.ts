...
export const getPostAllauthClientV1AccountPasswordChangeMutationOptions = <TError = ErrorType<ErrorResponse | AuthenticationResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postAllauthClientV1AccountPasswordChange>>, TError,{client: 'app' | 'browser';data: BodyType<ChangePasswordBody>}, TContext>, }
): UseMutationOptions<Awaited<ReturnType<typeof postAllauthClientV1AccountPasswordChange>>, TError,{client: 'app' | 'browser';data: BodyType<ChangePasswordBody>}, TContext> => {
...
const {mutation: mutationOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof postAllauthClientV1AccountPasswordChange>>, {client: 'app' | 'browser';data: BodyType<ChangePasswordBody>}> = (props) => {
          const {client,data} = props ?? {};

          return  postAllauthClientV1AccountPasswordChange(client,data,)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PostAllauthClientV1AccountPasswordChangeMutationError = ErrorType<ErrorResponse | AuthenticationResponse>

    /**
 * @summary Change password
 */
export const usePostAllauthClientV1AccountPasswordChange = <TError = ErrorType<ErrorResponse | AuthenticationResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postAllauthClientV1AccountPasswordChange>>, TError,{client: 'app' | 'browser';data: BodyType<ChangePasswordBody>}, TContext>, }
