...
export const getPostAllauthBrowserV1AuthProviderRedirectMutationOptions = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postAllauthBrowserV1AuthProviderRedirect>>, TError,{data: BodyType<ProviderRedirectBody>}, TContext>, }
): UseMutationOptions<Awaited<ReturnType<typeof postAllauthBrowserV1AuthProviderRedirect>>, TError,{data: BodyType<ProviderRedirectBody>}, TContext> => {
...
const {mutation: mutationOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof postAllauthBrowserV1AuthProviderRedirect>>, {data: BodyType<ProviderRedirectBody>}> = (props) => {
          const {data} = props ?? {};

          return  postAllauthBrowserV1AuthProviderRedirect(data,)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PostAllauthBrowserV1AuthProviderRedirectMutationResult = NonNullable<Awaited<ReturnType<typeof postAllauthBrowserV1AuthProviderRedirect>>>
 ...
 * @summary Provider redirect
 */
export const usePostAllauthBrowserV1AuthProviderRedirect = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postAllauthBrowserV1AuthProviderRedirect>>, TError,{data: BodyType<ProviderRedirectBody>}, TContext>, }
...
export const getPostAllauthClientV1AuthProviderTokenMutationOptions = <TError = ErrorType<ErrorResponse | AuthenticationResponse | ForbiddenResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postAllauthClientV1AuthProviderToken>>, TError,{client: 'app' | 'browser';data: BodyType<ProviderTokenBody>}, TContext>, }
): UseMutationOptions<Awaited<ReturnType<typeof postAllauthClientV1AuthProviderToken>>, TError,{client: 'app' | 'browser';data: BodyType<ProviderTokenBody>}, TContext> => {
...
const {mutation: mutationOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof postAllauthClientV1AuthProviderToken>>, {client: 'app' | 'browser';data: BodyType<ProviderTokenBody>}> = (props) => {
          const {client,data} = props ?? {};

          return  postAllauthClientV1AuthProviderToken(client,data,)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PostAllauthClientV1AuthProviderTokenMutationResult = NonNullable<Awaited<ReturnType<typeof postAllauthClientV1AuthProviderToken>>>
    export type PostAllauthClientV1AuthProviderTokenMutationBody = BodyType<ProviderTokenBody>
    export type PostAllauthClientV1AuthProviderTokenMutationError = ErrorType<ErrorResponse | AuthenticationResponse | ForbiddenResponse>

    /**
 * @summary Provider token
 */
export const usePostAllauthClientV1AuthProviderToken = <TError = ErrorType<ErrorResponse | AuthenticationResponse | ForbiddenResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postAllauthClientV1AuthProviderToken>>, TError,{client: 'app' | 'browser';data: BodyType<ProviderTokenBody>}, TContext>, }
 , queryClient?: QueryClient): UseMutationResult<
...
export const getGetAllauthClientV1AuthProviderSignupQueryKey = (client: 'app' | 'browser',) => {
    return [`/_allauth/${client}/v1/auth/provider/signup`] as const;
    }

    
export const getGetAllauthClientV1AuthProviderSignupQueryOptions = <TData = Awaited<ReturnType<typeof getAllauthClientV1AuthProviderSignup>>, TError = ErrorType<ConflictResponse>>(client: 'app' | 'browser', options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getAllauthClientV1AuthProviderSignup>>, TError, TData>>, }
) => {

const {query: queryOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetAllauthClientV1AuthProviderSignupQueryKey(client);
   ...
   return  { queryKey, queryFn, enabled: !!(client), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getAllauthClientV1AuthProviderSignup>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}

export type GetAllauthClientV1AuthProviderSignupQueryResult = NonNullable<Awaited<ReturnType<typeof getAllauthClientV1AuthProviderSignup>>>
export type GetAllauthClientV1AuthProviderSignupQueryError = ErrorType<ConflictResponse>


export function useGetAllauthClientV1AuthProviderSignup<TData = Awaited<ReturnType<typeof getAllauthClientV1AuthProviderSignup>>, TError = ErrorType<ConflictResponse>>(
 client: 'app' | 'browser', options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof getAllauthClientV1AuthProviderSignup>>, TError, TData>> & Pick<
        DefinedInitialDataOptions<
...
export function useGetAllauthClientV1AuthProviderSignup<TData = Awaited<ReturnType<typeof getAllauthClientV1AuthProviderSignup>>, TError = ErrorType<ConflictResponse>>(
 client: 'app' | 'browser', options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getAllauthClientV1AuthProviderSignup>>, TError, TData>>, }
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
/**
 * @summary Provider signup information
...
export const getPostAllauthClientV1AuthProviderSignupMutationOptions = <TError = ErrorType<ErrorResponse | AuthenticationResponse | ForbiddenResponse | ConflictResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postAllauthClientV1AuthProviderSignup>>, TError,{client: 'app' | 'browser';data: BodyType<ProviderSignupBody>}, TContext>, }
): UseMutationOptions<Awaited<ReturnType<typeof postAllauthClientV1AuthProviderSignup>>, TError,{client: 'app' | 'browser';data: BodyType<ProviderSignupBody>}, TContext> => {
...
const {mutation: mutationOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof postAllauthClientV1AuthProviderSignup>>, {client: 'app' | 'browser';data: BodyType<ProviderSignupBody>}> = (props) => {
          const {client,data} = props ?? {};

          return  postAllauthClientV1AuthProviderSignup(client,data,)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PostAllauthClientV1AuthProviderSignupMutationResult = NonNullable<Awaited<ReturnType<typeof postAllauthClientV1AuthProviderSignup>>>
    export type PostAllauthClientV1AuthProviderSignupMutationBody = BodyType<ProviderSignupBody>
    export type PostAllauthClientV1AuthProviderSignupMutationError = ErrorType<ErrorResponse | AuthenticationResponse | ForbiddenResponse | ConflictResponse>

    /**
 * @summary Provider signup
 */
export const usePostAllauthClientV1AuthProviderSignup = <TError = ErrorType<ErrorResponse | AuthenticationResponse | ForbiddenResponse | ConflictResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postAllauthClientV1AuthProviderSignup>>, TError,{client: 'app' | 'browser';data: BodyType<ProviderSignupBody>}, TContext>, }
 , queryClient?: QueryClient): UseMutationResult<
