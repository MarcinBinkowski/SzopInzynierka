...
import type { ErrorType } from '../../../auth-mutator';
...
export const getGetAllauthClientV1AuthSessionQueryOptions = <TData = Awaited<ReturnType<typeof getAllauthClientV1AuthSession>>, TError = ErrorType<AuthenticationResponse | SessionGoneResponse>>(client: 'app' | 'browser', options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getAllauthClientV1AuthSession>>, TError, TData>>, }
) => {
...
export type GetAllauthClientV1AuthSessionQueryError = ErrorType<AuthenticationResponse | SessionGoneResponse>


export function useGetAllauthClientV1AuthSession<TData = Awaited<ReturnType<typeof getAllauthClientV1AuthSession>>, TError = ErrorType<AuthenticationResponse | SessionGoneResponse>>(
...
export function useGetAllauthClientV1AuthSession<TData = Awaited<ReturnType<typeof getAllauthClientV1AuthSession>>, TError = ErrorType<AuthenticationResponse | SessionGoneResponse>>(
 client: 'app' | 'browser', options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getAllauthClientV1AuthSession>>, TError, TData>>, }
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
/**
 * @summary Get authentication status
...
export const getDeleteAllauthClientV1AuthSessionMutationOptions = <TError = ErrorType<UnauthenticatedResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteAllauthClientV1AuthSession>>, TError,{client: 'app' | 'browser'}, TContext>, }
...
const {mutation: mutationOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof deleteAllauthClientV1AuthSession>>, {client: 'app' | 'browser'}> = (props) => {
          ...
          return  deleteAllauthClientV1AuthSession(client,)
        }
 ...
 * @summary Logout
 */
export const useDeleteAllauthClientV1AuthSession = <TError = ErrorType<UnauthenticatedResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteAllauthClientV1AuthSession>>, TError,{client: 'app' | 'browser'}, TContext>, }
