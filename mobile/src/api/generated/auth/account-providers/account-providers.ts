...
export const getGetAllauthClientV1AccountProvidersQueryKey = (client: 'app' | 'browser',) => {
    return [`/_allauth/${client}/v1/account/providers`] as const;
    }

    
export const getGetAllauthClientV1AccountProvidersQueryOptions = <TData = Awaited<ReturnType<typeof getAllauthClientV1AccountProviders>>, TError = ErrorType<unknown>>(client: 'app' | 'browser', options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getAllauthClientV1AccountProviders>>, TError, TData>>, }
) => {
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetAllauthClientV1AccountProvidersQueryKey(client);
   ...
   return  { queryKey, queryFn, enabled: !!(client), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getAllauthClientV1AccountProviders>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}

export type GetAllauthClientV1AccountProvidersQueryResult = NonNullable<Awaited<ReturnType<typeof getAllauthClientV1AccountProviders>>>
export type GetAllauthClientV1AccountProvidersQueryError = ErrorType<unknown>


export function useGetAllauthClientV1AccountProviders<TData = Awaited<ReturnType<typeof getAllauthClientV1AccountProviders>>, TError = ErrorType<unknown>>(
 client: 'app' | 'browser', options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof getAllauthClientV1AccountProviders>>, TError, TData>> & Pick<
        DefinedInitialDataOptions<
...
export function useGetAllauthClientV1AccountProviders<TData = Awaited<ReturnType<typeof getAllauthClientV1AccountProviders>>, TError = ErrorType<unknown>>(
 client: 'app' | 'browser', options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getAllauthClientV1AccountProviders>>, TError, TData>>, }
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
/**
 * @summary List the connected third-party provider accounts
...
export const getDeleteAllauthClientV1AccountProvidersMutationOptions = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteAllauthClientV1AccountProviders>>, TError,{client: 'app' | 'browser';data: BodyType<ProviderAccountBody>}, TContext>, }
): UseMutationOptions<Awaited<ReturnType<typeof deleteAllauthClientV1AccountProviders>>, TError,{client: 'app' | 'browser';data: BodyType<ProviderAccountBody>}, TContext> => {
...
const {mutation: mutationOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof deleteAllauthClientV1AccountProviders>>, {client: 'app' | 'browser';data: BodyType<ProviderAccountBody>}> = (props) => {
          const {client,data} = props ?? {};

          return  deleteAllauthClientV1AccountProviders(client,data,)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type DeleteAllauthClientV1AccountProvidersMutationResult = NonNullable<Awaited<ReturnType<typeof deleteAllauthClientV1AccountProviders>>>
 ...
 */
export const useDeleteAllauthClientV1AccountProviders = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteAllauthClientV1AccountProviders>>, TError,{client: 'app' | 'browser';data: BodyType<ProviderAccountBody>}, TContext>, }
