...
export const getGetAllauthClientV1AccountPhoneQueryOptions = <TData = Awaited<ReturnType<typeof getAllauthClientV1AccountPhone>>, TError = ErrorType<AuthenticationResponse>>(client: 'app' | 'browser', options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getAllauthClientV1AccountPhone>>, TError, TData>>, }
) => {
...
export function useGetAllauthClientV1AccountPhone<TData = Awaited<ReturnType<typeof getAllauthClientV1AccountPhone>>, TError = ErrorType<AuthenticationResponse>>(
...
export function useGetAllauthClientV1AccountPhone<TData = Awaited<ReturnType<typeof getAllauthClientV1AccountPhone>>, TError = ErrorType<AuthenticationResponse>>(
 client: 'app' | 'browser', options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getAllauthClientV1AccountPhone>>, TError, TData>>, }
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
/**
 * @summary Get the phone number
...
export const getPostAllauthClientV1AccountPhoneMutationOptions = <TError = ErrorType<ErrorResponse | AuthenticationOrReauthenticationResponse | ConflictResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postAllauthClientV1AccountPhone>>, TError,{client: 'app' | 'browser';data: BodyType<PhoneBody>}, TContext>, }
): UseMutationOptions<Awaited<ReturnType<typeof postAllauthClientV1AccountPhone>>, TError,{client: 'app' | 'browser';data: BodyType<PhoneBody>}, TContext> => {
...
const {mutation: mutationOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof postAllauthClientV1AccountPhone>>, {client: 'app' | 'browser';data: BodyType<PhoneBody>}> = (props) => {
          const {client,data} = props ?? {};

          return  postAllauthClientV1AccountPhone(client,data,)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PostAllauthClientV1AccountPhoneMutationError = ErrorType<ErrorResponse | AuthenticationOrReauthenticationResponse | ConflictResponse>

    /**
 * @summary Change the phone number

 */
export const usePostAllauthClientV1AccountPhone = <TError = ErrorType<ErrorResponse | AuthenticationOrReauthenticationResponse | ConflictResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postAllauthClientV1AccountPhone>>, TError,{client: 'app' | 'browser';data: BodyType<PhoneBody>}, TContext>, }
