 ...
 */
export const postAllauthClientV1AuthCodeConfirmParams = zod.object({
  "client": zod.enum(['app', 'browser']).describe('The type of client accessing the API.')
})

export const postAllauthClientV1AuthCodeConfirmBody = zod.object({
  "code": zod.string().describe('An one-time code.\n')
})

export const postAllauthClientV1AuthCodeConfirmResponse = zod.object({
