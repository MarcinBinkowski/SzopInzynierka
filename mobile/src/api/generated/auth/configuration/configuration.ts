...
export const getGetAllauthClientV1ConfigQueryOptions = <TData = Awaited<ReturnType<typeof getAllauthClientV1Config>>, TError = ErrorType<unknown>>(client: 'app' | 'browser', options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getAllauthClientV1Config>>, TError, TData>>, }
) => {
...
export function useGetAllauthClientV1Config<TData = Awaited<ReturnType<typeof getAllauthClientV1Config>>, TError = ErrorType<unknown>>(
...
export function useGetAllauthClientV1Config<TData = Awaited<ReturnType<typeof getAllauthClientV1Config>>, TError = ErrorType<unknown>>(
 client: 'app' | 'browser', options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getAllauthClientV1Config>>, TError, TData>>, }
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
/**
 * @summary Get configuration
