...
export const catalogWishlistListResponseItem = zod.object({
  ...
  "website": zod.url().max(catalogWishlistListResponseProductManufacturerWebsiteMax).optional().describe('Manufacturer website URL'),
...
export const catalogWishlistRetrieveResponse = zod.object({
  ...
  "description": zod.string().optional().describe('Manufacturer description'),
  "website": zod.url().max(catalogWishlistRetrieveResponseProductManufacturerWebsiteMax).optional().describe('Manufacturer website URL'),
  "is_active": zod.boolean().optional().describe('Whether this manufacturer is visible'),
  "active_product_count": zod.number(),
  "created_at": zod.iso.datetime({}).describe('Timestamp when the record was created'),
  "updated_at": zod.iso.datetime({}).describe('Timestamp when the record was last updated')
...
export const catalogWishlistUpdateResponse = zod.object({
  ...
  "description": zod.string().optional().describe('Manufacturer description'),
  "website": zod.url().max(catalogWishlistUpdateResponseProductManufacturerWebsiteMax).optional().describe('Manufacturer website URL'),
  "is_active": zod.boolean().optional().describe('Whether this manufacturer is visible'),
  "active_product_count": zod.number(),
  "created_at": zod.iso.datetime({}).describe('Timestamp when the record was created'),
  "updated_at": zod.iso.datetime({}).describe('Timestamp when the record was last updated')
...
export const catalogWishlistPartialUpdateResponse = zod.object({
  ...
  "description": zod.string().optional().describe('Manufacturer description'),
  "website": zod.url().max(catalogWishlistPartialUpdateResponseProductManufacturerWebsiteMax).optional().describe('Manufacturer website URL'),
  "is_active": zod.boolean().optional().describe('Whether this manufacturer is visible'),
  "active_product_count": zod.number(),
  "created_at": zod.iso.datetime({}).describe('Timestamp when the record was created'),
  "updated_at": zod.iso.datetime({}).describe('Timestamp when the record was last updated')
...
export const catalogWishlistFilteredRetrieveResponse = zod.object({
  ...
  "price": zod.regex(catalogWishlistFilteredRetrieveResponseProductPriceRegExp).describe('Product price'),
  "original_price": zod.regex(catalogWishlistFilteredRetrieveResponseProductOriginalPriceRegExp).describe('Original price for showing discounts'),
  "current_price": zod.string().describe('Get current price as formatted decimal string.'),
  "discount_percentage": zod.number().describe('Calculate discount percentage.'),
  ...
  "description": zod.string().optional().describe('Manufacturer description'),
  "website": zod.url().max(catalogWishlistFilteredRetrieveResponseProductManufacturerWebsiteMax).optional().describe('Manufacturer website URL'),
  "is_active": zod.boolean().optional().describe('Whether this manufacturer is visible'),
  "active_product_count": zod.number(),
  "created_at": zod.iso.datetime({}).describe('Timestamp when the record was created'),
  "updated_at": zod.iso.datetime({}).describe('Timestamp when the record was last updated')
