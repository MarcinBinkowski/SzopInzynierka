 ...
 * Get current user's notification preferences
 */
export const catalogNotificationsPreferencesMeRetrieve = (
 ...
 signal?: AbortSignal
      ...
      return shopInstance<NotificationPreference>(
      {url: `/api/catalog/notifications/preferences/me/`, method: 'GET', signal
    },
      );
    }
  

export const getCatalogNotificationsPreferencesMeRetrieveQueryKey = () => {
    return [`/api/catalog/notifications/preferences/me/`] as const;
    }

    
export const getCatalogNotificationsPreferencesMeRetrieveQueryOptions = <TData = Awaited<ReturnType<typeof catalogNotificationsPreferencesMeRetrieve>>, TError = ErrorType<unknown>>( options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof catalogNotificationsPreferencesMeRetrieve>>, TError, TData>>, }
) => {

const {query: queryOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getCatalogNotificationsPreferencesMeRetrieveQueryKey();

  

    const queryFn: QueryFunction<Awaited<ReturnType<typeof catalogNotificationsPreferencesMeRetrieve>>> = ({ signal }) => catalogNotificationsPreferencesMeRetrieve(signal);

      

      

   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof catalogNotificationsPreferencesMeRetrieve>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}

export type CatalogNotificationsPreferencesMeRetrieveQueryResult = NonNullable<Awaited<ReturnType<typeof catalogNotificationsPreferencesMeRetrieve>>>
export type CatalogNotificationsPreferencesMeRetrieveQueryError = ErrorType<unknown>


export function useCatalogNotificationsPreferencesMeRetrieve<TData = Awaited<ReturnType<typeof catalogNotificationsPreferencesMeRetrieve>>, TError = ErrorType<unknown>>(
  options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof catalogNotificationsPreferencesMeRetrieve>>, TError, TData>> & Pick<
        DefinedInitialDataOptions<
          Awaited<ReturnType<typeof catalogNotificationsPreferencesMeRetrieve>>,
          TError,
          Awaited<ReturnType<typeof catalogNotificationsPreferencesMeRetrieve>>
        > , 'initialData'
      >, }
...
export function useCatalogNotificationsPreferencesMeRetrieve<TData = Awaited<ReturnType<typeof catalogNotificationsPreferencesMeRetrieve>>, TError = ErrorType<unknown>>(
  options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof catalogNotificationsPreferencesMeRetrieve>>, TError, TData>>, }
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
...
export function useCatalogNotificationsPreferencesMeRetrieve<TData = Awaited<ReturnType<typeof catalogNotificationsPreferencesMeRetrieve>>, TError = ErrorType<unknown>>(
 ...
 , queryClient?: QueryClient 
  ...
  const queryOptions = getCatalogNotificationsPreferencesMeRetrieveQueryOptions(options)
