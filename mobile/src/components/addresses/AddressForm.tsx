        ...
        render={({ field: { onChange, value } }) => (
          <>
            <TextInput
              ...
              right={<TextInput.Icon icon="chevron-down" onPress={() => setCountryModalVisible(true)} />}
            ...
            <Portal>
              <Modal
                ...
                contentContainerStyle={{ backgroundColor: theme.colors.surface, margin: 20, borderRadius: 16 }}
              >
                    ...
                    <View style={{ maxHeight: 400 }}>
                      {countryOptions.map((country) => (
                        <List.Item
                          ...
                          right={(props) => value === country.id ? <List.Icon {...props} icon="check" /> : null}
                        />
                      ))}
                    </View>
                  </List.Section>
                  <Button mode="outlined" onPress={() => setCountryModalVisible(false)}>
                    Cancel
                  </Button>
                </View>
              </Modal>
