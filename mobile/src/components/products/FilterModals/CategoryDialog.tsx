...
import { List, Button, useTheme, ActivityIndicator, Dialog, Portal } from 'react-native-paper';
          ...
          {isLoading ? (
            ...
            <>
              <List.Item
                ...
                style={{
                  backgroundColor: !selectedCategory ? theme.colors.primaryContainer : undefined,
                }}
              />
                ...
                {categories.map((category) => (
                  <List.Item
                    ...
                    left={(props) => (
                      <List.Icon 
                        {...props} 
                        icon={selectedCategory === category.id ? 'check-circle' : 'radiobox-blank'} 
                      />
                    )}
