...
interface PaginatedFlatListProps<TData> extends Omit<FlatListProps<TData>, 'data' | 'renderItem' | 'onEndReached'> {
  query: UseInfiniteQueryResult<any, Error>;
  data: TData[];
  renderItem: ({ item, index }: { item: TData; index: number }) => React.ReactElement;
  emptyMessage?: string;
}
