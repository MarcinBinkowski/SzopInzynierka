    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('short_description', models.CharField(blank=True, help_text='Short description for listings', max_length=500)),
                ...
                ('original_price', models.DecimalField(decimal_places=2, help_text='Original price for showing discounts', max_digits=10, validators=[django.core.validators.MinValueValidator(Decimal('0.01'))])),
                ...
                ('is_visible', models.BooleanField(default=False, help_text='Is product visible to the users')),
                ('sale_start', models.DateTimeField(blank=True, null=True)),
                ('sale_end', models.DateTimeField(blank=True, null=True)),
                ('category', models.ForeignKey(help_text='Product category', on_delete=django.db.models.deletion.PROTECT, related_name='products', to='catalog.category')),
                ('tags', models.ManyToManyField(blank=True, help_text='Tags for filtering and search', to='catalog.tag')),
            ],
            options={
                'ordering': ['-created_at'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sort_order', models.PositiveIntegerField(default=0, help_text='Display order of images')),
                ('product', models.ForeignKey(help_text='Associated product', on_delete=django.db.models.deletion.CASCADE, related_name='images', to='catalog.product')),
            ],
            options={
        ...
        migrations.AddIndex(
            model_name='product',
            index=models.Index(fields=['status', 'is_visible'], name='catalog_pro_status_1a8990_idx'),
        ),
        migrations.AddIndex(
            model_name='product',
