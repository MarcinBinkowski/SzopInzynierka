...
class BrowserLoginRoleMiddleware:
    """
    Blocks USER role from logging into the dashboard via the browser client.

    Config (optional) in settings.py:
        BROWSER_LOGIN_PATH = "/_allauth/browser/v1/auth/login"
        BROWSER_CLIENT_NAME = "browser"
        DASHBOARD_FORBIDDEN_ROLES = {Profile.Role.USER}
    """
